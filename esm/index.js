...
import engineering from './engineering'; // color 颜色
...
export { gradient } from './color'; // string 字符串

export { calcStrLen } from './string';
export { fittingString } from './string';
export { getQueryString } from './string'; // object 对象

export { isNullOrEmpty } from './object'; // engineering 工程

export { debounce } from './engineering';
export default _objectSpread({}, color, {}, string, {}, object, {}, engineering);