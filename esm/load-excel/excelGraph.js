...
var ExcelGraph = /*#__PURE__*/function (_React$Component) {
  ...
  _proto.UNSAFE_componentWillReceiveProps = function UNSAFE_componentWillReceiveProps(next) {
    ...
    if (!_.isEqual(next.graphData, this.props.graphData)) {
      ...
      this.graph.changeData(g6Utils.handleGraphData({
        nodes: nodes,
        edges: edges
      }));
      this.graph.refresh();
  ...
  _proto.render = function render() {
    ...
    return /*#__PURE__*/React.createElement(Row, {
      ...
      className: "node-type"
    }, entTree && /*#__PURE__*/React.createElement(Tree, {
      showIcon: true,
      ...
      return /*#__PURE__*/React.createElement(TreeNode, {
        icon: child.iconId ? /*#__PURE__*/React.createElement("img", {
          alt: "",
          width: "20",
          height: "20",
        ...
        return /*#__PURE__*/React.createElement(TreeNode, {
          icon: v.iconId ? /*#__PURE__*/React.createElement("img", {
            alt: "",
            width: "20",
            height: "20",
      ...
      id: "demo-graph"
    }), this.state.config === 'node' ? /*#__PURE__*/React.createElement(ExcelConfig, {
      onChange: this.changeNode,
      nodeTypes: this.props.nodeTypes,
      LoadExcel: this.props.LoadExcel
    }) : /*#__PURE__*/React.createElement(ExcelEdgeConfig, {
